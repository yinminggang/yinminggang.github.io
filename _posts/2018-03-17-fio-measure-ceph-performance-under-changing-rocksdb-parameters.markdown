...
<div style="float:left;border:solid 1px 000;margin:2px;">
	<img src="/img/2018-03-17-fio-measure-ceph-performance-under-changing-rocksdb-parameters/parameter0_ioutil.png"  width="30%" height="50%">
</div>
<div style="float:left;border:solid 1px 000;margin:2px;">
	<img src="/img/2018-03-17-fio-measure-ceph-performance-under-changing-rocksdb-parameters/parameter0_write_throughput.png" width="30%" height="50%" >
</div>
<div style="float:left;border:solid 1px 000;margin:2px;">
